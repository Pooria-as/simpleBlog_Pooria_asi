<div class="col-md-4 col-xl-3">
    <div class="sidebar px-4 py-md-0">
      ...
      <form class="input-group" action="{{route("WelcomePage")}}" method="GET">
      ...
      <div class="row link-color-default fs-14 lh-24">
        ...
        <div class="col-6"><a href="{{route("RelatedCategoryPost",$category->id)}}">
        {{$category->name}}  
        </a></div>
        @endforeach
      ...
      <div class="gap-multiline-items-1">
        ...
        <a class="badge badge-secondary" href="{{route("RelatedtagPost",$tag->id)}}">
          {{$tag->name}}
        </a>
        @endforeach
